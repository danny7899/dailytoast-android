...
public class HomeTab2 extends Fragment {
    ...
    private ArrayList<DataObject> dataSet = new ArrayList<DataObject>(activityMain.dataSetFeatured);

    private static String LOG_TAG = "CardViewActivity on Featured Tab";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Collections.sort(dataSet, new SortView());

        //Setup RecyclerView
        mRecyclerView = (RecyclerView) v.findViewById(R.id.cardListTab2);
